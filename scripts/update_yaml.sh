...
if [ -f "$instanceFile" ]; then
    ...
    updated_mono_deployment_name="mono-deployment-name : $INSTANCE_NAME-$current_version"
    updated_orbit_sync_name="orbit_home_sync_image : hyd.ocir.io/idgrosnf0lwv/orbit-repo/orbit_home_sync:${VERSION}"
